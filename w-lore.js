...
export function makeLORE({ D, esc, todayStr, mulberry32 }) {
  ...
  // —— 故事线扩充 · 灯塔屿(到灯塔去)——
  lhwindow: { icon: '🪟', color: '#5a6a8a', title: '客厅的窗', en: 'The Window', hint: '拉姆齐夫人坐过的地方',
    desc: '"明天要是天好,就去灯塔。"拉姆齐夫人坐在窗边织袜子,应下小詹姆斯。窗外的浪应了一声,又收回去。这一句"明天",隔了十年才兑现。' },
  lhtime: { icon: '⏳', color: '#4a4a56', title: '空屋十年', en: 'Time Passes', hint: '中间那一章',
    desc: '一夜接一夜,风从锁孔进来,披巾松开,墙皮剥落。全书最短的一章过去了十年——括号里死了三个人。空屋自己活着,像一枚没人听的钟。' },
  lhlily: { icon: '🎨', color: '#7a5a72', title: '莉丽的画架', en: "Lily's Easel", hint: '把树往中间挪一挪',
    desc: '莉丽·布里斯科对着草坪支了十年的画架。有人断言"女人画不了画",她没吵,只把那棵树往画布中间挪了挪。最后一笔落下,她想:完成了,我看见我的幻象了。' },
  lhboat: { icon: '⛵', color: '#3a5a7a', title: '去灯塔的船', en: 'The Sail to the Lighthouse', hint: '十年后的兑现',
    desc: '拉姆齐先生终于带着詹姆斯和凯姆扬帆去灯塔。少年掌舵避过暗礁,沉默寡言的老人破天荒夸了句"干得好"。船靠上礁石那一刻,岸上的莉丽轻声说:他到了。' },
  // —— 楚门的世界 ——
  trumoon: { icon: '🌕', color: '#8a8a6a', title: '那轮月亮', en: 'The Moon', hint: '导演住在里面',
    desc: '桃源镇的月亮从不缺席,亮得也太均匀了些。里面是控制室:基斯督坐在环形屏幕前,三十年没下过班。"外面的世界和我给你的一样虚假——但在我这里,你没什么可怕的。"' },
  truexit: { icon: '🚪', color: '#4a6a8a', title: '海天尽头的门', en: 'The Exit', hint: '天空是一堵墙',
    desc: '船艏撞破的地方,"天空"露出一道楼梯和一扇小门,门牌写着 EXIT。楚门在这里朝观众鞠了一躬:"以防以后见不着——祝你早安、午安,还有晚安。"' },
  trulight: { icon: '💡', color: '#7a6a3a', title: '坠落的摄影灯', en: 'SIRIUS (9 Canis Major)', hint: '从天上掉下来的星',
    desc: '一盏舞台灯砸在街心,标签写着"天狼星"。广播随即解释:飞机零件脱落,请勿围观。楚门抬头看了看天——从那天起,他开始数街上重复出现的路人。' },
  truradio: { icon: '📻', color: '#5a5a6a', title: '串台的电台', en: 'The Radio', hint: '它在报你的位置',
    desc: '车载收音机忽然串台:"他正沿斯图尔特街向西……"每个转弯都被提前报出。楚门猛打方向盘,电台一阵忙乱。有些真相不是看见的,是听漏的。' },
  // —— 中土 ——
  midbagend: { icon: '🚪', color: '#5a7a3a', title: '袋底洞的圆门', en: 'Bag End', hint: '绿色的门,黄铜把手',
    desc: '地底洞府里住着一位霍比特人。不是脏兮兮的湿洞,也不是光秃秃的沙洞:这是霍比特人的洞,而这意味着舒适。圆门上还有道新刻痕——甘道夫用手杖划的:"盗贼,求职。"' },
  middoom: { icon: '🌋', color: '#8c3a1a', title: '末日裂隙', en: 'The Cracks of Doom', hint: '铸成它的地方',
    desc: '火山口的热风掀动斗篷。铸成魔戒的地方,也是唯一能销毁它的地方。有人在最后关头说了"魔戒是我的"——然后是咕噜、断指、一声长长的坠落。伟业的最后一步,常常不是走出来的,是摔出来的。' },
  midgollum: { icon: '💍', color: '#3a4a44', title: '咕噜的池子', en: "Gollum's Pool", hint: '我们的宝贝',
    desc: '黑暗的水潭边,鱼骨排得整整齐齐。它在这儿住了五百年,和自己下棋、吵架、和好。"我们恨它,我们爱它。"——当年比尔博放下剑的那一次心软,是整个中土最要紧的一次。' },
  mideagle: { icon: '🦅', color: '#7a6a4a', title: '巨鹰的落羽', en: 'The Eagles', hint: '它们总在最后一刻来',
    desc: '一根比人还长的翎羽插在山坡上。风王关赫领着它们来过两次:一次去火山,一次赴黑门。至于"为什么不一开始就骑鹰去"——巨鹰不是出租车,它们是骄傲本身。' },
  // —— 霍格沃茨 ——
  hoghat: { icon: '🎩', color: '#5a4a3a', title: '分院帽', en: 'The Sorting Hat', hint: '它看的是你的选择',
    desc: '一顶打满补丁的旧尖帽搁在木凳上,闻一闻你的头顶就开唱:勇敢?忠诚?智慧?野心?哈利在帽檐下默念了半天"不要斯莱特林"——帽子说:好吧,那就,格兰芬多!你的选择,和天赋一样重要。' },
  hoghall: { icon: '✨', color: '#6a5a2a', title: '大礼堂的飘烛', en: 'The Great Hall', hint: '天花板是天空',
    desc: '数百支蜡烛悬在半空,天花板被施了魔法,和外面的夜空一模一样。赫敏说这写在《霍格沃茨:一段校史》里——她是全年级唯一读过那本书的人。' },
  hogforest: { icon: '🌲', color: '#2e4a34', title: '禁林边界', en: 'The Forbidden Forest', hint: '名字里就有答案',
    desc: '树影浓得化不开。海格提着灯笼说:跟紧我,里面有独角兽,也有别的东西。一年级新生的关禁闭方式居然是夜探禁林——霍格沃茨的安全观,一向很有想象力。' },
  hogmap: { icon: '🗺️', color: '#6a5a44', title: '活点地图', en: "The Marauder's Map", hint: '我庄严宣誓我不干好事',
    desc: '一张看似空白的羊皮纸。念对咒语,城堡的每条密道、每个人的脚印都会浮现;看完记得敲一下:"恶作剧完毕。"否则下一个打开它的,可能是斯内普教授。' },
  // —— 体育岛 ——
  spttunnel: { icon: '🎽', color: '#8c2a2a', title: '球员通道', en: 'The Tunnel', hint: '草皮前最后一段黑暗',
    desc: '从更衣室到草皮的短短通道,墙上一行字:"This is Old Trafford."九万双眼睛在尽头等着。老队长说:走过这段黑,你就属于红色。' },
  sptfergie: { icon: '⏱️', color: '#6a2a2a', title: '弗格森时间', en: 'Fergie Time', hint: '补时永远不够,又永远刚好',
    desc: '第四官员举牌:补时 4 分钟。全场倒吸一口气——在这座球场,最后四分钟发生过太多事:99 年那两个球,就是在这样的时间进的。哨响之前,谁也别急着走。' },
  sptstretford: { icon: '🔴', color: '#a03030', title: '斯特雷特福德看台', en: 'The Stretford End', hint: '声浪从这里先起',
    desc: '红色的海从这一侧先唱起来,《Glory Glory Man United》一浪压过一浪。据说客队球员罚点球前都不敢看这面看台——不是怕嘘声,是怕那种整齐。' },
  sptball: { icon: '⚽', color: '#5a5a5a', title: '92 班的旧皮球', en: 'The Old Ball', hint: '磨白的训练球',
    desc: '草皮边一颗磨得发白的皮球。吉格斯用它练过盘带,贝克汉姆用它练过圆月弯刀,斯科尔斯用它练过——呃,铲球就算了。天才是练出来的,这颗球可以作证。' },
  // —— 南塔开特 ——
  mobahab: { icon: '🦵', color: '#4a3e36', title: '鲸骨腿的踱痕', en: "Ahab's Ivory Stride", hint: '甲板上的圆坑',
    desc: '码头木板上一排小圆坑——船长的鲸骨假腿,千百个来回踱出来的。"别对我说亵渎,人若侮辱我,我连太阳也照打不误。"他把一枚金币钉上桅杆:谁先看见白鲸,金币归谁。' },
  mobtry: { icon: '🔥', color: '#6a3a1a', title: '炼油炉', en: 'The Try-Works', hint: '海上的炼狱',
    desc: '两口大锅架在砖炉上,鲸脂翻滚成油,夜里火光把船帆映成红的。以实玛利在舵位上盯着火出神,差点把船开翻——他说:别看火太久,火会把海看成地狱。' },
  mobchart: { icon: '📍', color: '#3a4a5a', title: '海图上的针脚', en: 'The Chart', hint: '四十年的执念',
    desc: '摊开的海图密密麻麻全是针孔——亚哈用四十年,把白鲸出没的洋流一针一针钉了出来。最后一个针孔落在赤道渔场。他算对了——这才是最可怕的。' },
  // —— 鹦鹉螺锚地 ——
  nemsalon: { icon: '🖼️', color: '#2a3a4a', title: '鹦鹉螺号客厅', en: 'The Grand Salon', hint: '海底的卢浮宫',
    desc: '一万两千册藏书、拉斐尔与达·芬奇的真迹、玻璃柜里椰子大的珍珠——全在海面之下。尼摩船长说:大海不属于暴君。而图书馆,属于每一个肯潜下来的人。' },
  nemmotto: { icon: '⚙️', color: '#4a5a5a', title: '船铭', en: 'Mobilis in Mobili', hint: '动中之动',
    desc: '黄铜铭牌擦得锃亮:Mobilis in Mobili。阿龙纳斯教授翻译了三遍才满意:在流动中流动,以动应动。一句拉丁文,写尽了一条船和一个人的活法。' },
  // —— 赤壁 ——
  cbizhe: { icon: '⚔️', color: '#5a4a3a', title: '折戟', en: 'The Broken Halberd', hint: '沉沙铁未销',
    desc: '滩涂里半截断戟,锈成了礁石的颜色。"折戟沉沙铁未销,自将磨洗认前朝。"几百年后杜牧路过,替一场大火补写了收据。' },
  cbige: { icon: '🍶', color: '#4a3a4a', title: '横槊赋诗处', en: 'The Poem on the Prow', hint: '对酒当歌',
    desc: '大战前夜,曹操横槊立于船头:"对酒当歌,人生几何。"八十万人的战场,他先想到的是人生苦短。诗写得极好——只是第二天的风向,不太配合。' },
  // —— 梁山泊 ——
  lspflag: { icon: '🚩', color: '#b8862e', title: '替天行道大旗', en: 'The Banner', hint: '杏黄色',
    desc: '聚义厅前杏黄大旗猎猎,四个大字:替天行道。一百单八人,人人来路不同——有被逼的,有被骗的,也有自己跳上山的。旗下不问出身,只问一碗酒敢不敢干。' },
  lspwillow: { icon: '🌳', color: '#4a6a3a', title: '倒拔垂杨柳', en: 'The Uprooted Willow', hint: '树坑还在',
    desc: '那棵垂杨柳不在这里,但树坑的故事人人会讲:鲁智深嫌树上乌鸦聒噪,弯腰、抱树、一声喝——连根拔起。泼皮们从此改口叫师父。武力值的尽头,是园艺。' },
  // —— 风车原野 ——
  fcyhelmet: { icon: '🪖', color: '#8a7a4a', title: '曼布里诺头盔', en: "Mambrino's Helmet", hint: '其实是个铜盆',
    desc: '木架上供着一只锃亮的铜盆——骑士坚称这是刀枪不入的曼布里诺头盔,理发师坚称这是他的刮脸盆。双方各有道理,但只有一方挨过揍。' },
  fcydonkey: { icon: '🐴', color: '#7a6a5a', title: '桑丘的驴槽', en: "Dapple's Trough", hint: '总督的坐骑',
    desc: '灰驴槽边歪歪扭扭刻着一行字:"总督专用"。桑丘·潘沙坚信总有一天能当上海岛总督——后来他真当上了,又主动辞了职:"赤条条来,赤条条去,不亏。"' },
  // —— 大观园 ——
  dgyzhu: { icon: '🎋', color: '#3a6a4a', title: '潇湘馆竹影', en: 'The Bamboo of Xiaoxiang', hint: '凤尾森森,龙吟细细',
    desc: '千百竿翠竹遮映,苔痕上阶绿。黛玉说:我最爱这几竿竹子,隐着一道曲栏,比别处更觉幽静。风过时竹叶沙沙,像有人把没说出口的话,都寄存给了竹子。' },
  dgytaixu: { icon: '📜', color: '#6a5a7a', title: '太虚幻境的对联', en: 'The Arch of Illusion', hint: '假作真时真亦假',
    desc: '石牌坊上一副对联:"假作真时真亦假,无为有处有还无。"宝玉梦里来过,翻过金陵十二钗的册子,一页也没看懂。等他看懂的时候,书就该收尾了。' },
  // —— 塞壬海域 ——
  sirwax: { icon: '🕯️', color: '#8a7a5a', title: '蜂蜡小罐', en: 'The Beeswax', hint: '塞耳朵用的',
    desc: '礁石缝里一只陶罐,罐底还剩一层软蜡。奥德修斯把它揉软,给每个水手塞住耳朵——只留自己被绑在桅杆上听歌。聪明人连"想听"这件事,都提前设计好了安全措施。' },
  sirsong: { icon: '🎶', color: '#4a5a6a', title: '半句歌词', en: 'The Half-heard Song', hint: '刻在漂流木上',
    desc: '一块漂流木,刻着半句听不全的歌:"来吧,我们知道你所有的……"后半句被浪磨掉了。据说这正是塞壬的高明:让你用余生去补全。' },
  // —— 单卡补充 ——
  shjxingtian: { icon: '🪓', color: '#8c2f10', title: '刑天', en: 'Xing Tian', hint: '以乳为目,以脐为口',
    desc: '断头的巨人仍在挥舞干戚,乳为目,脐为口,一招一式舞得一丝不苟。陶渊明替他写过评语:"刑天舞干戚,猛志固常在。"输了头颅,没输志气。' },
  anhsesame: { icon: '🚪', color: '#b8862e', title: '芝麻之门', en: 'The Sesame Door', hint: '口令别记错',
    desc: '石壁严丝合缝,只认一句口令。阿里巴巴的哥哥进去装满金币,却把口令忘了,对着石门喊了一晚上"大麦开门""小米开门"……贪心的下场,有时只是记性不好。' },
  jurdna: { icon: '🧬', color: '#3a6a5a', title: 'DNA 先生放映厅', en: 'Mr. DNA', hint: '欢迎观看科普片',
    desc: '卡通双螺旋在幕布上鞠躬:"我们从琥珀里的蚊子肚子里,抽出了恐龙的血!"缺的基因用青蛙补齐——哈蒙德博士鼓掌,马尔科姆博士扶额。后来的一切证明:掌声不如扶额。' },
  alctea: { icon: '🫖', color: '#7a4a6a', title: '永远六点钟', en: 'The Mad Tea-Party', hint: '时间在这桌罢工了',
    desc: '长桌摆满茶具,疯帽子和三月兔永远在喝下午茶——时间先生跟他们闹翻了,把这一桌定格在六点整。"换位子!"于是所有人挪一格,用干净杯子,续昨天的茶。' },
  hgsyou: { icon: '✍️', color: '#8a6a3a', title: '到此一游碑', en: 'The Pillar Inscription', hint: '五指山的笔迹',
    desc: '一根粗大的"擎天柱"上歪歪扭扭一行字:"齐天大圣到此一游",落款处还有一泡猴尿的旧渍。后来他才知道,那五根柱子是如来的手指。人这一生,总有几笔字想擦掉。' },
  b612fox: { icon: '🦊', color: '#c87f2f', title: '狐狸的麦田', en: "The Fox's Wheat", hint: '驯养我吧',
    desc: '一小片麦田,风吹过是金色的浪。狐狸说:你有一头金色的头发,等你驯养了我,麦子的颜色就会让我想起你。"实质性的东西,用眼睛是看不见的。"这句话,是它教的。' },
  lrsxiaoqian: { icon: '🏮', color: '#6a3a4a', title: '井台的纸灯', en: "Xiaoqian's Lantern", hint: '夜里会自己亮',
    desc: '荒寺井台上搁着一盏纸灯,入夜自己亮起来。小倩说她被埋在寺后白杨树下:"妾身非人,君勿惧。"宁采臣没跑。世上的鬼故事分两半——一半是人吓人,这一半,是人暖鬼。' },
  thyji: { icon: '🐔', color: '#6a9c50', title: '鸡犬相闻', en: 'The Sound of Home', hint: '篱笆那头',
    desc: '竹篱笆里几只芦花鸡踱步,黄狗趴在门槛上眼皮都懒得抬。武陵人进村那天它们叫过一阵,后来就不叫了——外人来不来,日子都是这么过。' },
  // —— 🌊 八仙过海(三仙岛海域)——
  bxhulu: { icon: '🫙', color: '#8a5a2a', title: '铁拐李的宝葫芦', en: 'The Gourd of Li Tieguai', hint: '空,才浮得起来',
    desc: '宝葫芦往海里一抛,涨大如舟。铁拐李抱着铁拐斜躺在上面,任浪头起落,鼾声比涛声还稳。有人讨教渡海秘诀,他敲敲葫芦:"空,才浮得起来。"' },
  bxshan: { icon: '🪭', color: '#7a6a3a', title: '汉钟离的芭蕉扇', en: 'The Fan of Zhongli Quan', hint: '扇面即筏',
    desc: '袒胸露腹的大汉把芭蕉扇往水上一铺,扇面便是筏。他躺在扇上摇一柄小扇,扇自己,也扇天下——据说这扇能起死回生,他却最常拿来扇凉快。' },
  bxlvzi: { icon: '🫏', color: '#8a8478', title: '张果老的纸驴', en: 'The Paper Donkey', hint: '为何倒骑?',
    desc: '纸驴踏浪如履平地,不用时折成一张纸,揣进袖里。老神仙一路倒骑。问他为何,他捋捋白须:"往前赶路的人太多了——总得有人替大家看看来时的路。"' },
  bxjian: { icon: '⚔️', color: '#4a5a8a', title: '吕洞宾的纯阳剑', en: 'The Sword of Lü Dongbin', hint: '剑化长虹',
    desc: '纯阳剑掷出,化一道长虹横跨海面,剑仙踏虹而行,袍袖里还揣着酒。剑斩过恶蛟,也断过烦恼——他说后者难得多。' },
  bxhe: { icon: '🪷', color: '#b06a8a', title: '何仙姑的荷花', en: 'The Lotus of He Xiangu', hint: '步步生莲',
    desc: '一朵粉荷浮在浪上,花瓣舒展如舟。何仙姑执荷而立,裙裾不沾一滴水——八仙里唯一的女仙,渡海的姿态也最从容:急什么,潮水自会把该到的都送到。' },
  bxlan: { icon: '🧺', color: '#2e8a6a', title: '蓝采和的花篮', en: 'The Flower Basket', hint: '篮盛四时花',
    desc: '花篮里盛着四时之花:春兰秋菊,夏荷冬梅,在同一只篮里同时开。蓝采和一脚踏篮,且行且歌"踏踏歌"。后来在海上被龙宫掳走的,正是这位爱唱歌的——那又是另一段了。' },
  bxdi: { icon: '🎶', color: '#3a6a8a', title: '韩湘子的玉笛', en: 'The Flute of Han Xiangzi', hint: '笛声引鲸',
    desc: '玉笛横吹,笛声落进海里,引来一头老鲸驮他前行。韩湘子盘坐鲸背,一曲接一曲——鱼虾听得跃出水面,连风都放轻了脚步。渡海用了整整三天:不是慢,是舍不得吹完。' },
  bxyu: { icon: '🀄', color: '#6a5a7a', title: '曹国舅的玉板', en: 'The Jade Tablet', hint: '沉在龙宫的那件',
    desc: '玉板拍浪,声震海底,惊动了东海龙宫。龙太子起了贪心,夺玉板、掳走蓝采和——八仙怒而倾山倒海,虾兵蟹将溃不成军,观音赶来才平了这场仗。玉板从此留了道裂纹,沉在这海底暗道里,等一个识货的人。' },
  bxyan: { icon: '🍑', color: '#b8862e', title: '八仙宴', en: 'The Feast of the Eight Immortals', hint: '蓬莱之约',
    desc: () => { let n9 = 0; try { n9 = (localStorage.getItem('w1001.bx') || '').split(',').filter(Boolean).length; } catch (e) {}
      return n9 >= 8
        ? '石桌上九副杯箸,八仙依次入席:铁拐李的葫芦斟酒,汉钟离的扇扇火,张果老倒骑着驴打瞌睡,何仙姑的荷花开在桌心……徐福求了一辈子仙山不得其门,八位谈笑间踏浪而至。第九副杯箸,是给你的——各显神通渡海的人,都算同道。'
        : '三仙岛的石桌上摆着九副杯箸,座次空着。石面刻一行小字:"渡海之宝集齐八件,宴席自开。"(在这片海域寻访八仙的渡海法器——有一件,听说沉在海底龙宫。)'; } },
  // —— 船只 encounter:海上四艘传奇 ——
