...
export const MAZE_PORTALS = [   // n=节点索引, isle=浮出海岛, surf=浮出坐标, col=浮标色, cave=可步行洞窟
  ...
  { n: 13, isle: '废矿海城', surf: [333, -1672], col: 0x6a7684, cave: true },  // 沉船墓地:矿工口中的"邻居"
  { n: 1, isle: '真名植物岛', surf: [-1674, 533], col: 0xc05a4a },             // 乳香色浮标
  { n: 4, isle: '静默之岩', surf: [1456, -1456], col: 0xd8d2c2 },              // 气室节点:呼吸即祷告
  { n: 44, isle: '龙蜥荒原', surf: [1696, -1696], col: 0xc8a04a, cave: true },  // 鲸骨王朝:龙与骨
  { n: 45, isle: '方舟大陆岛', surf: [-1626, 1416], col: 0x8ac06a },            // 珊瑚回廊:方舟航线
  { n: 46, isle: '风中庄园', surf: [1658, 1658], col: 0xb0a8c8 },               // 星象水道:星星不认得皇冠
  { n: 47, isle: '三仙岛', surf: [927, -1240], col: 0x9fc8e8 },                 // 星象水道:望仙
  { n: 48, isle: '石刻武学岛', surf: [-1385, -1338], col: 0xd8ccb0, cave: true },// 鲸骨王朝:石窟步行可入
  { n: 49, isle: '桃阵岛', surf: [1068, 1487], col: 0xf0b8c8 },                 // 珊瑚回廊:桃色浮标
  { n: 50, isle: '看不见的水城', surf: [591, 1755], col: 0x6ab0c8 },            // 珊瑚回廊:水巷之下
  { n: 51, isle: '冰火萨迦岛', surf: [-1778, -57], col: 0xbfe8f0, cave: true },  // 星象水道:熔岩洞步行可入
  { n: 52, isle: '沉环之岛', surf: [-315, -1793], col: 0x9ab0c0 },              // 沉船墓地:沉城的邻居
];
