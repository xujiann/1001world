...
export function makeNIContent(C) {
  ...
  mys: {
    ...
    lore: {
      ...
      mysttele: { icon: '📡', color: '#4a5a6a', title: '荒岛电报线', en: 'The Telegraph', hint: '第四年,通电',
        desc: '从花岗石宫到畜栏,一根自制电线翻山而过。落难第四年,这座荒岛有了电报——文明不是被带上岛的,是被五个人一伏特一伏特造出来的。' },
    },
    spots: [[-2, -4, 'mystvolcano'], [16, -10, 'mystforge'], [-20, 16, 'mystnemo'], [24, 20, 'mystballoon'], [-30, -18, 'mystbottle'], [8, 28, 'mysttele']],
    npcs: [
  ...
  trs: {
    ...
    lore: {
      ...
      trsparrot: { icon: '🦜', color: '#2e8b57', title: '弗林特船长', en: "Cap'n Flint", hint: '八个里亚尔!',
        desc: '西尔弗肩头的老鹦鹉,据说两百岁,见过真正的弗林特埋宝。它只会喊一句"八个里亚尔!"——一句话的回忆录,信息量却比全船人都大。' },
    },
    spots: [[10, 14, 'pirateflag'], [-18, -12, 'skullrock'], [0, -2, 'treasuredig'], [28, -24, 'bengunn'], [-26, 18, 'applebarrel'], [-6, 26, 'trsparrot']],
    npcs: [
  ...
  chr: {
    ...
    lore: {
      ...
      chrchina: { icon: '🍽️', color: '#6a5a4a', title: '餐桌上的小瓷人', en: 'The China Figures', hint: '每晚少一个',
        desc: '长餐桌正中十个小瓷人,晚饭后总会莫名少一个。数瓷人成了岛上最恐怖的餐后运动——数到七的那晚,没有人敢先睡。' },
      chrstorm: { icon: '⛈️', color: '#3a4450', title: '断航的风暴', en: 'The Storm', hint: '船不来了',
        desc: '风暴一起,大陆的船就断了航。没有电话,没有退路,十个人和一句童谣关在同一座岛上——凶手不用逃,他只需要等。' },
    },
    spots: [[0, 3, 'tensoldiers'], [0, -8, 'chrmansion'], [16, 12, 'chrgramo'], [-24, -18, 'chrcliff'], [26, 2, 'chrchina'], [-10, 20, 'chrstorm']],
    npcs: [
  ...
  tmp: {
    ...
    lore: {
      ...
      tmpstaff: { icon: '🪄', color: '#4a3a5a', title: '折断的法杖', en: 'The Broken Staff', hint: '魔法的终点',
        desc: '"我将折断我的法杖,埋入地下几寻深;把我的书,沉进测锤达不到的海底。"报了仇的魔法师,最后选择了饶恕和退休——《暴风雨》是莎翁的告别演出。' },
      tmpmiranda: { icon: '💞', color: '#7a5a6a', title: '米兰达的惊叹', en: 'Brave New World', hint: '人类多么美丽',
        desc: '"神奇啊!这里有多少好看的人!人类是多么美丽!啊,新奇的世界!"——说这话时,她一共见过三个人。赫胥黎后来借走了这句感叹,反着用。' },
    },
    spots: [[0, 2, 'prospero'], [12, -8, 'ariel'], [-16, -14, 'caliban'], [22, -24, 'tmpwreck'], [-24, 8, 'tmpstaff'], [8, 16, 'tmpmiranda']],
    npcs: [
  ...
  mor: {
    ...
    lore: {
      ...
      morsay: { icon: '🗣️', color: '#5a4a3a', title: '诵法处', en: 'The Saying of the Law', hint: '我们不是人吗?',
        desc: '兽人们围着火堆齐声背诵:"不用四足行走,这是律法。我们不是人吗?不吮吸饮水,这是律法。我们不是人吗?"背得越整齐,越让人心里发毛。' },
      morscar: { icon: '🧪', color: '#4a5a5a', title: '手术台的皮带', en: 'The Table', hint: '名为科学的暴行',
        desc: '白屋子里一张台子,四条磨亮的皮带。莫罗博士管这叫"塑造",兽人们管这叫"痛苦之屋"。半夜的嚎叫停了很多年了,梦见的还是会梦见。' },
    },
    spots: [[0, 6, 'morlaw'], [-12, -8, 'morhouse'], [20, -18, 'morpuma'], [-26, 16, 'morboat'], [10, 22, 'morsay'], [-22, -20, 'morscar']],
    npcs: [
  ...
  dol: {
    ...
    lore: {
      ...
      dolskirt: { icon: '🪶', color: '#3a6a6a', title: '鸬鹚羽裙', en: 'The Cormorant Skirt', hint: '十八年里最亮的一件',
        desc: '卡拉娜用一个冬天缝的裙子:黑羽泛着绿光,走起来像披了一片会动的海。荒岛求生十八年,人不止需要活着——还需要一件好看的东西。' },
      dolfence: { icon: '🦴', color: '#8a8478', title: '鲸骨栅栏', en: 'The Whale-rib Fence', hint: '巨鲸的馈赠',
        desc: '搁浅巨鲸的肋骨插成一圈,便是她的院墙。骨头比木头白,比石头轻,夜里挡风,白天挡野狗——大海拿走了她的族人,又一根一根还她一个家。' },
    },
    spots: [[0, 4, 'karana'], [14, -10, 'otterbay'], [-18, -16, 'dolrontu'], [26, 14, 'dolship'], [8, 24, 'dolskirt'], [-26, 6, 'dolfence']],
    npcs: [
  ...
  fly: {
    ...
    lore: {
      ...
      flyfire: { icon: '🔥', color: '#8c4a1a', title: '信号火堆', en: 'The Signal Fire', hint: '火灭的那天',
        desc: '山顶的火堆是回家唯一的指望。可看火的人跑去打猎了——火灭的那个下午,海平线上真的驶过一条船。文明的熄灭不轰轰烈烈,就是一次值班脱岗。' },
      flypaint: { icon: '🎭', color: '#6a3a2a', title: '涂脸的陶土', en: 'The Painted Faces', hint: '面具背后无人',
        desc: '红的白的陶土往脸上一抹,镜子里就换了一个人。涂了彩的猎手们又笑又叫——羞耻和名字一起被盖住了,从此干什么都"不是我干的"。' },
    },
    spots: [[0, 4, 'flyconch'], [-2, -8, 'flybeast'], [22, -20, 'flylord'], [-22, 14, 'flyglasses'], [10, 20, 'flyfire'], [-14, -22, 'flypaint']],
    npcs: [
  ...
  uto: {
    ...
    lore: {
      ...
      utopass: { icon: '🛂', color: '#4a5a6a', title: '旅行许可证', en: 'The Travel Pass', hint: '出门要打报告',
        desc: '乌托邦人出远门须持执照,结伴而行,到哪儿都得干活。防的不是逃亡——岛上没什么可逃的——防的是闲逛。一个不许无所事事的天堂,你细品。' },
      utowar: { icon: '🕊️', color: '#6a5a4a', title: '雇佣兵账本', en: 'The Mercenary Ledger', hint: '道德洁癖的算术',
        desc: '乌托邦人厌恶战争,真打起来就雇邻国的凶悍民族上阵,金币照付,死伤不论。自己人一滴血不流,账本干干净净——理想国的道德,也有外包条款。' },
    },
    spots: [[0, 4, 'utocity'], [14, -8, 'utogold'], [-22, 16, 'utodine'], [24, 18, 'utofarm'], [-12, -14, 'utopass'], [6, 26, 'utowar']],
    npcs: [
  ...
  hux: {
    ...
    lore: {
      ...
      awakenhere: { icon: '🕰️', color: '#5a6a5a', title: '此时此地钟', en: 'The Here-and-Now Clock', hint: '它不报时',
        desc: '岛上的钟没有指针,整点只报四个字:"此时,此地。"帕拉人说,过去是回忆,未来是想象,人真正拥有的只有敲钟这一刻——这钟从不走慢,因为它压根不走。' },
    },
    spots: [[0, 4, 'mynah'], [12, -6, 'moksha'], [24, 16, 'huxscare'], [-20, -14, 'huxbook'], [-10, 20, 'awakenhere']],
    npcs: [
  ...
  gul: {
    ...
    lore: {
      ...
      gulegg: { icon: '🥚', color: '#8a7a4a', title: '大小端之争', en: 'Big-Endians', hint: '从哪头磕鸡蛋',
        desc: '利立浦特与邻国血战三十六个月,起因:磕鸡蛋该磕大头还是小头。双方各出十一卷论著,烈士上万——斯威夫特耸耸肩:诸位的战争,大多是这颗鸡蛋换个名字。' },
    },
    spots: [[0, 3, 'lilliput'], [16, -10, 'laputa'], [-20, 12, 'gulrope'], [-8, -18, 'gulfire'], [22, 8, 'gulegg']],
    npcs: [
  ...
  nvl: {
    ...
    lore: {
      ...
      nvlshadow: { icon: '👤', color: '#3a3a4a', title: '缝影子的针线包', en: 'The Shadow', hint: '影子晾在抽屉里',
        desc: '彼得的影子被抽屉夹断,他试着用肥皂把它粘回去——不行,急得直哭。温迪一针一线替他缝回脚跟。影子这种东西,丢了才知道是自己的。' },
      nvlkiss: { icon: '🎀', color: '#7a4a5a', title: '一枚"吻"', en: 'The Thimble', hint: '顶针',
        desc: '彼得不知道吻是什么,温迪只好把顶针给了他,说:这就是吻。后来那枚顶针替他挡过一支毒箭。你看,吻是能救命的,顶针也是。' },
    },
    spots: [[0, 4, 'lostchildren'], [16, -8, 'mermaidlagoon'], [-20, -12, 'nvlcroc'], [-14, 16, 'nvlwendy'], [10, 22, 'nvlshadow'], [-26, 2, 'nvlkiss']],
    npcs: [
  ...
  cor: {
    ...
    lore: {
      ...
      corbread: { icon: '🍞', color: '#8a6a3a', title: '面包果烤坑', en: 'The Breadfruit Oven', hint: '没有面粉的面包',
        desc: '把面包果埋进烧热的石坑,焖出来外焦里糯,真有面包香。三个少年从此顿顿自夸:全南太平洋最好的面包房,员工三人,不接外单。' },
      corshark: { icon: '🦈', color: '#3a5a6a', title: '鲨口脱险处', en: 'The Shark', hint: '运气与祷告各一半',
        desc: '杰克划水的手背擦过一片砂纸似的东西——鲨鱼贴着他转了两圈,被一桨柄敲在鼻尖上才走。事后拉尔夫总结:上帝保佑,加上彼得金嗓门够大。' },
    },
    spots: [[0, 4, 'coralreef'], [-12, -6, 'coralboys'], [16, 18, 'corcandle'], [-22, 12, 'corcave2'], [24, -8, 'corbread'], [-6, 24, 'corshark']],
    npcs: [
  ...
  typ: {
    ...
    lore: {
      ...
      typtattoo: { icon: '🖋️', color: '#4a5a5a', title: '纹身师的骨针', en: 'The Tattoo Needle', hint: '一针一针的履历',
        desc: '骨针蘸着烛果烟灰,敲进皮肤便是一生的档案:出身、战功、爱过谁。纹身师三次要给托莫的脸开工,他死活捂着——脸要留着回文明世界用。' },
      typescape: { icon: '🏃', color: '#6a4a3a', title: '托莫的逃亡', en: 'The Escape', hint: '瘸着腿跑向海',
        desc: '腿伤未愈的托莫瘸着冲下山谷,身后是挽留他的整个部落——盛情到让人分不清是客人还是藏品。捕鲸艇的桨声,是他此生听过最好的音乐。' },
    },
    spots: [[0, 4, 'typeevalley'], [14, -8, 'typeetabu'], [22, 16, 'typfeast'], [-18, -14, 'typkory'], [8, 24, 'typtattoo'], [-24, 6, 'typescape']],
    npcs: [
  ...
  tah: {
    ...
    lore: {
      ...
      tahblind: { icon: '🕯️', color: '#5a4a3a', title: '失明后的壁画', en: 'The Last Mural', hint: '遗嘱:烧掉',
        desc: '眼睛看不见的最后一年,他把毕生的幻象画满四壁——看过的医生说,那近乎伟大,也近乎可怕。遗嘱只有一句:我死后,连房子一起烧掉。烧了,就完整了。' },
      tahletter: { icon: '✉️', color: '#6a5a4a', title: '没寄出的信', en: 'The Unsent Letter', hint: '证券行的旧同事',
        desc: '伦敦的老同事至今想不通:四十岁,妻儿体面,饭碗铁打,怎么说走就走。他只留下一句:"我必须画画,就像溺水的人必须挣扎。"' },
    },
    spots: [[0, 4, 'studio'], [14, -6, 'sixpence'], [-20, 14, 'tahata'], [22, 12, 'tahdoctor'], [8, 22, 'tahblind'], [-12, -16, 'tahletter']],
    npcs: [
  ...
  daw: {
    ...
    lore: {
      ...
      dawskin: { icon: '🐲', color: '#4a6a4a', title: '蜕下的龙皮', en: 'The Dragon Skin', hint: '自己挠了三层',
        desc: '尤斯塔斯变成龙后拼命挠自己,挠掉一层又一层,底下还是龙。狮子说:得我来。利爪撕下最深那层时疼极了——然后他重新变回了男孩,一个好了很多的男孩。' },
      dawmouse: { icon: '🗡️', color: '#7a4a2a', title: '雷佩契普的小剑', en: "Reepicheep's Sword", hint: '世界尽头的浪',
        desc: '桨鼠骑士把小剑插进甜水的浪里,只身划向阿斯兰之乡——预言说他会抵达最东方。船员们目送小舟翻过那道立着的浪,谁都没敢说"再见"。' },
    },
    spots: [[0, 4, 'dragonisle'], [16, -8, 'worldsend'], [-22, 14, 'dawpool'], [26, 10, 'dawstar'], [-8, -18, 'dawskin'], [6, 26, 'dawmouse']],
    npcs: [
  ...
  rain: {
    ...
    lore: {
      ...
      raidrum: { icon: '🌧️', color: '#4a5a66', title: '铁皮屋顶', en: 'The Tin Roof', hint: '敲了十四天',
        desc: '雨点在铁皮屋顶上敲了十四个昼夜,不重,但一刻不停。它敲塌的不是屋顶,是一位圣人绷了半辈子的弦——毛姆全篇没写一个"欲"字,全让雨替他写了。' },
      rairoad: { icon: '⛵', color: '#5a6a6a', title: '去阿皮亚的班船', en: 'The Steamer', hint: '检疫十四天',
        desc: '班船因疫情滞留,传教士、医生和汤普森小姐被雨关进同一家旅店。要是船准点开,他们一辈子不会说上第二句话——命运的手段,常常只是一纸检疫单。' },
    },
    spots: [[0, 4, 'rainhotel'], [12, -8, 'missionary'], [-16, 14, 'raingramo'], [20, 12, 'raindoc'], [-8, -18, 'raidrum'], [24, -2, 'rairoad']],
    npcs: [
  ...
  shu: {
    ...
    lore: {
      ...
      shurule: { icon: '🔢', color: '#4a4a56', title: '4 的法则', en: 'The Rule of 4', hint: '67 号病人是谁',
        desc: '纸条上两行字:"4 的法则;67 号病人是谁?"泰迪警官把它当密码破了一路——破到最后发现,答案不在纸上,在照镜子的人脸上。' },
      shuchoice: { icon: '💊', color: '#5a5a6a', title: '台阶上的最后一问', en: 'The Last Question', hint: '怪物,还是好人',
        desc: '"像怪物一样活着,还是像好人一样死去?"他问得平静,然后跟着白大褂走了。同伴到最后也没确定:他是没治好,还是治好了装没好。' },
    },
    spots: [[0, 4, 'shuward'], [-2, -10, 'shulighthouse'], [-22, 14, 'shucave'], [18, 16, 'shustorm'], [10, 26, 'shurule'], [-14, -20, 'shuchoice']],
    npcs: [
  ...
  gala: {
    ...
    lore: {
      ...
      galabeagle: { icon: '⛵', color: '#3a5a7a', title: '小猎犬号锚位', en: 'HMS Beagle', hint: '1835 年 9 月',
        desc: '1835 年 9 月,小猎犬号在此下锚,一个 26 岁的博物学青年背着标本箱上了岸,待了五个星期。他当时没觉得有什么——二十四年后,那五个星期变成了《物种起源》。' },
    },
    spots: [[6, 20, 'galacrater'], [-18, -8, 'galastation'], [22, -14, 'galafinch'], [-26, 18, 'galaiguana'], [30, 8, 'galalab'], [-8, 32, 'galabeagle']],
    npcs: [
  ...
  moai: {
    ...
    lore: {
      ...
      moaibird: { icon: '🐣', color: '#5a6a4a', title: '鸟人竞赛', en: 'Tangata Manu', hint: '第一枚燕鸥蛋',
        desc: '每年春天,各部落勇士攀下断崖、泅过鲨海,去小岛抢第一枚乌燕鸥蛋。蛋绑在额头游回来,湿都不能湿——赢者的首领便是这一年的"鸟人",代神发言。' },
    },
    spots: [[0, 28, 'moairow'], [26, 20, 'moaiquarry'], [-16, 4, 'moaidan'], [8, 38, 'moaigaze'], [-8, -26, 'moaicrane'], [20, -12, 'moaibird']],
    npcs: [
  ...
  fogjail: {
    ...
    lore: {
      ...
      fogspoon: { icon: '🥄', color: '#6a6a6a', title: '一把汤勺', en: 'The Spoon', hint: '1962 年 6 月',
        desc: '食堂里最普通的一把勺。1962 年 6 月,三个人用它和五十副假睡的面孔,挖穿了"绝无可能越狱"的墙。海雾至今没交出他们的下落——勺子还在,墙的自尊没了。' },
    },
    spots: [[-6, -10, 'fogcell'], [10, 2, 'fogfile'], [24, -20, 'foglight'], [-20, 12, 'fogyard'], [-2, 30, 'fogescape'], [14, 22, 'fogspoon']],
    npcs: [
  ...
  kilda: {
    ...
    lore: {
      ...
      kildasheep: { icon: '🐑', color: '#8a8478', title: '索艾羊', en: 'The Soay Sheep', hint: '比人待得久',
        desc: '一种石器时代就上岛的原始绵羊,毛自己脱,崖自己爬,人走了它们留下。如今全岛的"居民"就是它们——圣基尔达的历史,人类只是路过的一章。' },
    },
    spots: [[-4, 2, 'kildastreet'], [16, -14, 'kildacleit'], [4, -30, 'kildacliff'], [-8, 34, 'kildamail'], [8, 4, 'kildahearth'], [-18, -16, 'kildasheep']],
    npcs: [
  ...
  gunkan: {
    ...
    lore: {
      ...
      gunkanpiano: { icon: '🎹', color: '#4a4a52', title: '俱乐部的钢琴', en: 'The Piano', hint: '煤都琴声',
        desc: '巅峰时这里人口密度世界第一,矿工俱乐部却真有一架钢琴。下了井的手,晚上也想弹点什么——水泥森林最深处,文娱是氧气的一种。' },
    },
    spots: [[-6, 34, 'gunkwall'], [4, -6, 'gunkflats'], [14, 6, 'gunkschool'], [-16, -12, 'gunkshaft'], [22, -18, 'gunkkey'], [8, 18, 'gunkanpiano']],
    npcs: [
  ...
  soco: {
    ...
    lore: {
      ...
      socorose: { icon: '🌵', color: '#b06a7a', title: '沙漠玫瑰', en: 'The Desert Rose', hint: '瓶子形的树',
        desc: '树干鼓得像陶瓶,雨季把水全存进肚子,旱季在光秃的枝头开一树粉花。植物学家叫它瓶树,岛民叫它沙漠玫瑰——在最吝啬的土地上,它把储蓄开成了炫耀。' },
    },
    spots: [[0, 4, 'socodragon'], [20, 18, 'socobottle'], [-24, 12, 'sococave'], [16, -16, 'socoincense'], [-6, -8, 'soconame'], [26, -4, 'socorose']],
    npcs: [
  ...
  skell: {
    ...
    lore: {
      ...
      skellink: { icon: '✒️', color: '#3a4a5a', title: '橡果墨水', en: 'The Oak-gall Ink', hint: '抄过黑暗时代',
        desc: '蜂巢石屋里,僧侣用橡瘿和铁锈调墨,一笔一画抄写经卷。欧洲大陆战火连天的几百年,不少文明就靠这座海中孤岩上的墨水活了下来——抄写,也是一种守城。' },
    },
    spots: [[-8, 30, 'skellsteps'], [2, -2, 'skellcell'], [14, 6, 'skellgarden'], [-10, 2, 'skellbook'], [-2, -24, 'skellbird'], [10, -14, 'skellink']],
    npcs: [
  ...
  helena: {
    ...
    lore: {
      ...
      helwave: { icon: '🌊', color: '#3a5a7a', title: '两千英里的海', en: 'The Sea Wall', hint: '最后的疆土',
        desc: '曾号令百万大军的人,最后的疆土是目力所及的浪——离最近的大陆两千公里。他每天在崖边站一小时,副官不敢问在看什么。看什么呢?看地图上找不到的那条回程。' },
    },
    spots: [[0, 0, 'helwood'], [12, 12, 'helgarden'], [-18, 22, 'helwalk'], [-6, -22, 'hellear'], [16, -14, 'helstar'], [-22, -6, 'helwave']],
    npcs: [
  ...
  komodo: {
    ...
    lore: {
      ...
      komeat: { icon: '🍖', color: '#6a4a3a', title: '喂龙台旧址', en: 'The Feeding Site', hint: '后来停了',
        desc: '早年每周宰一头山羊喂龙给游客看,巨蜥们准点赴宴,像上班。后来保护区停了这出戏:龙该自己捕猎——把猛兽喂成演员,是人对野性最客气的羞辱。' },
    },
    spots: [[2, 6, 'komdragon'], [-18, -8, 'komsaga'], [16, -18, 'komsavanna'], [-8, 22, 'komstation'], [10, 34, 'komreef'], [24, 14, 'komeat']],
    npcs: [
  ...
  shixia: {
    ...
    lore: {
      ...
      xkwho: { icon: '❓', color: '#5a5a5a', title: '无名落款', en: 'The Unsigned Wall', hint: '刻的人不要名字',
        desc: '满壁武学,招式图谱精细到指节,却找不到一个落款。守崖的老人说:要名字的人不会把功夫刻在石头上白送——他只要一件事,有人接着练下去。' },
    },
    spots: [[0, 6, 'xkcave'], [-14, 12, 'xkbei'], [16, 18, 'xkfan'], [10, -4, 'xkkeng'], [-6, -16, 'xklast'], [22, 6, 'xkwho']],
    npcs: [
  ...
  taozhen: {
    ...
    lore: {
      ...
      tzgate: { icon: '🚪', color: '#7a4a5a', title: '生门', en: 'The Gate of Life', hint: '入阵先找它',
        desc: '桃林即阵图,八门按奇门排布。入阵的规矩只有一条:先找生门,认准了再走,一步不回头。找不到怎么办?守林人笑笑:那就在花里坐着,等花谢——阵随花谢自己开。' },
    },
    spots: [[0, 20, 'tzlin'], [2, 0, 'tzbell'], [-16, -12, 'tzting'], [8, -34, 'tzdao'], [-4, 6, 'tztao'], [18, 14, 'tzgate']],
    npcs: [
  ...
  venezia: {
    ...
    lore: {
      ...
      vzhorse: { icon: '🐴', color: '#6a5a4a', title: '没有马的城', en: 'The City Without Horses', hint: '桥就是街',
        desc: '全城找不到一匹马、一辆车:石桥四百座,巷宽一臂,货靠船,人靠腿。外乡人问"马路在哪",船夫指指运河——在这座城,路是液体的。' },
    },
    spots: [[0, 10, 'vzcanal'], [-16, -2, 'vzbridge'], [12, 26, 'vzmarco'], [16, -12, 'vzmask'], [-8, 22, 'vzflood'], [24, 4, 'vzhorse']],
    npcs: [
  ...
  saga: {
    ...
    lore: {
      ...
      sgthing: { icon: '🏛️', color: '#4a5a6a', title: '露天议会', en: 'The Althing', hint: '草地就是议事厅',
        desc: '公元 930 年起,全岛的自由民每年夏天在熔岩裂谷集会立法断案——世界上最古老的议会,议事厅是草地,扩音器是议长的嗓门。开会开了一千年,那块草地还在用。' },
    },
    spots: [[-12, 18, 'sggeyser'], [16, -8, 'sglava'], [-4, -2, 'sgrune'], [6, 14, 'sgskald'], [-6, -26, 'sgaurora'], [20, 6, 'sgthing']],
    npcs: [
  ...
  atl: {
    ...
    lore: {
      ...
      atecho: { icon: '🌊', color: '#2a4a6a', title: '沉城回声', en: 'The Echo Below', hint: '风平浪静时来听',
        desc: '海面彻底平静的清晨,把耳朵贴近水面,据说能听见极远处一记钟声。是沉城的钟,还是浪撞礁洞的回音?渔夫们不争论——他们只是那天不下网。' },
    },
    spots: [[54, -4, 'atcliff'], [40, 8, 'atplato'], [60, 30, 'atruin'], [66, 14, 'atbell'], [70, -14, 'atvine'], [48, 22, 'atecho']],
    npcs: [
  ...
  aeol: {
    ...
    lore: {
      ...
      aeolknot: { icon: '🪢', color: '#5a6a7a', title: '三个风结', en: 'The Three Knots', hint: '第三个别解',
        desc: '老水手的规矩:买风要买打了结的绳。解一个,微风;解两个,劲风;第三个——问的人多,解过的都没回来讲课。' },
      aeolreturn: { icon: '🌀', color: '#4a5a6a', title: '第二次敲门', en: 'The Second Visit', hint: '风王闭门谢客',
        desc: '船员偷开风袋,舰队被吹回原点。奥德修斯硬着头皮再上门求风,风王埃俄罗斯隔门摆手:被诸神厌弃的人,本店概不二次接待。' },
    },
    spots: [[0, 6, 'aeolbag'], [4, -20, 'aeolstrom'], [-8, 34, 'aeolharbor'], [18, 12, 'aeolvane'], [-18, -8, 'aeolknot'], [26, 22, 'aeolreturn']],
    npcs: [
  ...
  wg: {
    ...
    lore: {
      ...
      wghorn: { icon: '📯', color: '#5a6a7a', title: '雾号', en: 'The Foghorn', hint: '每三十秒一声',
        desc: '浓雾一起,港口的雾号便每三十秒鸣一声,低沉得像从海底发出。船靠它辨方位,岛上的人靠它睡觉——哪天雾散了号停了,反倒一港口的人集体失眠。' },
    },
    spots: [[4, 12, 'wgship'], [32, -6, 'wgquay'], [-50, 30, 'wgdike'], [-10, -30, 'wgtale'], [-30, 8, 'wghorn']],
    npcs: [
  ...
  qq: {
    ...
    lore: {
      ...
      qqhuo: { icon: '🔥', color: '#2e8b8b', title: '狐火', en: 'Foxfire', hint: '别挡道',
        desc: '夜里山道上飘着一串蓝绿的火,不烫,也不灭。老人说那是狐狸嫁女的灯笼队,看见了就靠边站——你让它一条道,它记你一辈子好。' },
      qqjiu: { icon: '🍶', color: '#8a5a3a', title: '青丘酿', en: 'The Fox Brew', hint: '埋足一百年',
        desc: '青石下埋足一百年的酒,开坛那夜香出三里地,满山狐狸都醉了,吊着嗓子唱到天亮。第二天下山的货郎说,听着不像狐鸣,倒像一群书生在背诗。' },
    },
    spots: [[0, -6, 'qqsquare'], [-2, 10, 'qqtram'], [-18, 12, 'qqfox'], [32, 32, 'qqhai'], [12, 24, 'qqhuo'], [-26, -8, 'qqjiu']],
    npcs: [
  ...
  tusi: {
    ...
    lore: {
      ...
      tusimap: { icon: '🗺️', color: '#6a5a3a', title: '雨天画的地图', en: 'The Map', hint: '一切从涂鸦开始',
        desc: '一个下雨的假期,他给继子画了张海岛藏宝图解闷,随手标上"骷髅岛""望远镜山"。画着画着自己入了迷——那张涂鸦后来有了个书名:《金银岛》。' },
      tusiname: { icon: '🖋️', color: '#5a4a3a', title: '图西塔拉', en: 'Tusitala', hint: '讲故事的人',
        desc: '萨摩亚人不叫他史蒂文森先生,叫他 Tusitala——讲故事的人。他死时四十四岁,岛民连夜劈山开路,把他抬上瓦埃亚山顶,让他躺在能看见海的地方。' },
    },
    spots: [[0, 4, 'tusihouse'], [-6, -14, 'tusipath'], [2, -26, 'tusigrave'], [8, 8, 'tusistory'], [16, -6, 'tusimap'], [-14, 4, 'tusiname']],
    npcs: [
